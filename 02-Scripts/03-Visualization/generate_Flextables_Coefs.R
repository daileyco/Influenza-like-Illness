# script to format summary & coef tables and save to word doc


## load data
load("./03-Output/01-Tables/tables_summaries.rdata")
load("./03-Output/01-Tables/table_coefs.rds")
...
## save
save(ft.list, 
     file = "./03-Output/01-Tables/flextables_coefs.rds")
